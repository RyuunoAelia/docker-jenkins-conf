...
ENV \
  ...
  JENKINS_CONFIG_REPO= \
  JENKINS_CONFIG_REPO_REF= \
  JENKINS_CONFIG_REPO_USERNAME= \
  JENKINS_CONFIG_REPO_PASSWORD= \
  ...
  JENKINS_LDAP_GROUP_SEARCH_FILTER='gid={0}' \
  ...
  JENKINS_PIPELINE_LIB_REPO_USERNAME= \
  JENKINS_PIPELINE_LIB_REPO_PASSWORD= \
  JENKINS_PIPELINE_LIB_REPO_REF= \
  JENKINS_PLUGINS= \
